...
- **Background × Layout** — Background: None or a picture. Layout (only with a background): **Full width** = a fixed 1920×1080 presentation frame with the recording centred; **Hug** = the frame wraps the recording with a 5% margin. With no background the recording is the whole video (1920 wide landscape, 1080 wide portrait). Replaces Padding S/M/L and Orientation. iPhone content gets iPhone-style rounded corners.
